        ...
        <div id="form-container" class="max-w-md mx-auto bg-white rounded-xl shadow-2xl overflow-hidden relative z-10">
            <div class="p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-sm text-gray-600">Join our community today!</p>
                </div>
                <form id="registerForm" class="space-y-6">
                    <div class="relative">
                        ...
                        <input type="text" id="username" name="username" required class="pl-10 w-full py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder-gray-500" placeholder="Username">
                    </div>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="confirm_password" name="confirm_password" required class="pl-10 w-full py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder-gray-500" placeholder="Confirm Password">
                    </div>
                    <div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">Already have an account? <a href="#" class="font-medium text-blue-500 hover:text-blue-600">Sign in</a></p>
                </div>
            </div>
        </div>
    </div>
